...
import { ShoppingBag, ArrowRight, Sparkles, ChevronUp, Bot, Heart, DollarSign, Dumbbell, Share2, GraduationCap, Zap, Star } from 'lucide-react';
  ...
  const mainAIs = [
    {
      id: 'love-ai',
      title: 'Love AI',
      description: 'Relationship guidance and emotional support',
      icon: Heart,
    ...
    },
    {
      id: 'health-ai',
      title: 'Health AI',
      description: 'Wellness, fitness, and holistic health',
      icon: Dumbbell,
    ...
    },
    {
      id: 'career-ai',
      title: 'Career AI',
      description: 'Professional growth and business guidance',
      icon: Bot,
    ...
    },
    {
      id: 'nova-ai',
      title: 'Nova AI',
      description: 'Advanced AI companion for complex tasks',
      icon: Zap,
    ...
    },
    {
      id: 'spark-ai',
      title: 'Spark AI',
      description: 'Creative inspiration and innovation',
      icon: Star,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            <div className="inline-flex items-center px-6 py-3 glass-morphism rounded-full text-cyan-300 text-lg font-medium mb-8">
              <ShoppingBag className="w-5 h-5 mr-3" />
              Your AI Store
            </div>
            <h2 className="text-5xl lg:text-6xl font-bold text-white mb-8">
              Your AI <span className="bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent">Store</span>
            </h2>
          ...
          {/* Compact Preview - AI Grid (6 AIs) */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {mainAIs.slice(0, 6).map((ai, index) => {
              const IconComponent = ai.icon;
              return (
                <div key={ai.id} className={`${ai.glassClass} rounded-2xl p-6 text-center transform hover:scale-105 transition-all duration-300 animate-slide-in-up hover-lift glass-shine`} style={{ animationDelay: `${index * 0.1}s` }}>
                  <div className="w-16 h-16 mx-auto mb-4 relative">
                    <div className={`w-full h-full rounded-2xl bg-gradient-to-r ${ai.gradient} flex items-center justify-center relative overflow-hidden`}>
                  ...
                  <div className="text-cyan-300 font-semibold">From $300/year</div>
                </div>
              );
            })}
          </div>
          ...
          {isExpanded && (
            <div id="store-expanded" className="animate-fade-in-up">
              ...
              <div className="glass-card rounded-3xl p-12 mb-12 text-center hover-lift">
                ...
                <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed">
                  Get all AI Buddies plus the ability to create and sell your own Personal Buddy. 
                ...
                <button className="glass-button px-10 py-4 text-white rounded-full font-semibold text-lg hover-lift">
                  Get Premium Package
                </button>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {mainAIs.map((ai, index) => {
                  const IconComponent = ai.icon;
                  return (
                    <div key={ai.id} className={`${ai.glassClass} rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 animate-slide-in-up hover-lift glass-shine`} style={{ animationDelay: `${index * 0.1}s` }}>
                      <div className="w-16 h-16 mx-auto mb-4 relative">
                        <div className={`w-full h-full rounded-2xl bg-gradient-to-r ${ai.gradient} flex items-center justify-center relative overflow-hidden`}>
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-pulse"></div>
                          <IconComponent className="w-8 h-8 text-white relative z-10" />
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-sm font-bold text-cyan-300">$300/year</div>
                        <button className="glass-morphism px-4 py-2 text-white rounded-full hover:bg-white/20 transition-all duration-300 font-medium text-sm">
                          Add to Cart
                        </button>
                      </div>
                    </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="glass-card rounded-2xl p-8 text-center hover-lift">
                  ...
                  <button className="w-full glass-morphism px-6 py-3 text-white rounded-full hover:bg-white/20 transition-all duration-300 font-medium">
                    Choose Bundle
                  </button>
                </div>

                <div className="glass-card rounded-2xl p-8 text-center border-2 border-cyan-400/50 hover-lift">
                  ...
                  <p className="text-white/70 mb-4">All AI Buddies</p>
                  <div className="text-2xl font-bold text-cyan-300 mb-4">$1,500</div>
                  <div className="text-sm text-green-400 mb-4">Save $300</div>
                  <button className="w-full glass-button px-6 py-3 text-white rounded-full font-medium">
                    Get Complete Bundle
                  </button>
                </div>
